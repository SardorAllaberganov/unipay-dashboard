// Tap-to-copy payout ID — canonical pattern per LESSONS 2026-05-11.
// Pattern mirror of TransactionIdCopy; should be promoted to a shared
// CopyableId primitive when the 3rd consumer (API key fingerprint?) lands.
...
export function PayoutIdCopy({ value, leading = 4, trailing = 4, className }: Props) {
